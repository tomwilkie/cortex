...
func (ev *evaluator) eval(expr Expr) Value {
	...
	switch e := expr.(type) {
	case *AggregateExpr:
		return ev.aggregation(e.Op, e.Grouping, e.Without, e.Param, e.Expr)
...
func (ev *evaluator) aggregation(op itemType, grouping []string, without bool, param Expr, expr Expr) Vector {
